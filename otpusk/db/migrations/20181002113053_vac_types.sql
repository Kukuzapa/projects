...
INSERT INTO vac_type (type) VALUES ('Ежегодный (основной) оплачиваемый отпуск');
INSERT INTO vac_type (type) VALUES ('Отпуск без сохранения заработной платы');
INSERT INTO vac_type (type) VALUES ('Ежегодный дополнительный оплачиваемый отпуск');
INSERT INTO vac_type (type) VALUES ('Учебный отпуск');
INSERT INTO vac_type (type) VALUES ('Отпуск по беременности и родам (декретный отпуск)');
INSERT INTO vac_type (type) VALUES ('Отпуск по уходу за ребенком');
-- +goose StatementEnd
