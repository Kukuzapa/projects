    ...
    <div class="row">
        <form class="col-12">
            <div class="row">
                ...
                <div class="col-12">
                    <button type="button" class="btn btn-primary btn-block" @click="registrar_limits">Запросить информацию о регистраторе</button>
                </div>
        ...
        <div v-if="success" class="col-12 mt-2">
            <div class="row">
                ...
                <div class="col-6 mt-3">
                    <div v-for="(value, key) in limits" :key="key">
                        <p>{{ key }}: {{ value }}</p>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        registrar_limits: function(){
            this.error   = null;
            this.err_msg = null;
            this.success = null;
            
            this.axios.get( 'registrar/limits/' + this.registrar ).then( response => {
