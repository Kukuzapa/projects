    ...
    <div class="row">
        ...
        <form class="col-12">
            <div class="row">
                ...
                <div class="col-12">
                    <button type="button" class="btn btn-primary btn-block" @click="contact_copy">Скопировать контакт в кеш.</button>
                </div>
...
export default {
    ...
    methods:{
        ...
        contact_copy: function(){
            ...
            this.axios.get( 'contact/copy/' + this.tldmn, { params: request } ).then( response => {
