...
local function typeexpr(ctx, jsontype, datatype, tablekind)
  ...
  if jsontype == 'object' then
    return sformat(' (%s == "table" and %s <= 1) or %s == nil ', datatype, tablekind, ctx:param(1))
  ...
  elseif jsontype == 'integer' then
    return sformat(' tostring(tonumber(%s)) == %s ', ctx:param(1), ctx:param(1))
--[[
    return sformat(' (%s == "number" or %s(%s), 1.0) == 0.0) ',
